...
export var ParserRules:NearleyRule[] = [
    ...
    {"name": "value", "symbols": ["functions"], "postprocess": id},
    {"name": "functions", "symbols": [{"literal":"div"}, {"literal":"("}, "exp", {"literal":","}, "exp", {"literal":")"}], "postprocess": ([, ,lhs, , rhs,]) => (new Div(lhs,rhs))},
    {"name": "functions", "symbols": [{"literal":"mod"}, {"literal":"("}, "exp", {"literal":","}, "exp", {"literal":")"}], "postprocess": ([, ,lhs, , rhs,]) => (new Mod(lhs,rhs))},
    {"name": "functions", "symbols": [{"literal":"length"}, {"literal":"("}, "exp", {"literal":")"}], "postprocess": ([, , exp, ]) => (new Length(exp))},
    {"name": "functions", "symbols": [{"literal":"string"}, {"literal":"("}, "exp", {"literal":")"}], "postprocess": ([, , exp,]) => (new String(exp))},
    {"name": "functions", "symbols": [{"literal":"boolean"}, {"literal":"("}, "exp", {"literal":")"}], "postprocess": ([, , exp,]) => (new Boolean(exp))},
    {"name": "functions", "symbols": [{"literal":"number"}, {"literal":"("}, "exp", {"literal":")"}], "postprocess": ([, , exp,]) => (new Number(exp))},
    {"name": "functions", "symbols": [{"literal":"int"}, {"literal":"("}, "exp", {"literal":")"}], "postprocess": ([, , exp,]) => (new Int(exp))},
    {"name": "functions", "symbols": ["lists"], "postprocess": id},
    ...
    {"name": "exp_list", "symbols": ["exp_list", {"literal":","}, "exp"], "postprocess": ([list,,exp]) => { console.log(exp); list.push(exp); return list; }},
