...
export var ParserRules:NearleyRule[] = [
    ...
    {"name": "lists", "symbols": ["sets"]},
    {"name": "sets", "symbols": [{"literal":"{"}, "elems", {"literal":"}"}], "postprocess": ([, elems,]) => (new QSet(elems))},
    {"name": "sets", "symbols": [{"literal":"{"}, {"literal":"}"}], "postprocess": ([,]) => (new QSet([]))},
    {"name": "sets", "symbols": [{"literal":"{"}, "exp", {"literal":"for"}, "exp_list", {"literal":"}"}], "postprocess": ([,exp,,list,]) => (new ListComprehension(exp, list, true))},
